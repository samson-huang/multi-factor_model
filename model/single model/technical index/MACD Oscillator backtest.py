...
def main():
    ...
    ma1=5 #ma1=int(input('ma1:'))
    ma2=14 #ma2=int(input('ma2:'))
    stdate='2018-01-01'#stdate=input('start date in format yyyy-mm-dd:')
    eddate='2018-12-31'#eddate=input('end date in format yyyy-mm-dd:')
    ticker='MSFT'#ticker=input('ticker:')
    ...
    slicer=30 #slicer=int(input('slicing:'))
